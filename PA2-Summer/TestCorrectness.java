...
public class TestCorrectness {
	...
	public static void testBinarySearchMethods() {
		...
		System.out.println("Number of occurrences of 1 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, 1));
		System.out.println("Number of occurrences of 14 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, 14));
		System.out.println("Number of occurrences of 39 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, 39));
		System.out.println("Number of occurrences of 7 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, 7));
		System.out.println("Number of occurrences of 100 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, 100));
		System.out.println("Number of occurrences of -88 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, -88));
		System.out.println("Number of occurrences of 16 is " + BinarySearchApplications.countNumberOfKeys(A, A.length, 16));
